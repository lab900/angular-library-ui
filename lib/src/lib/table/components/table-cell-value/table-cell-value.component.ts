...
export class Lab900TableCellValueComponent<T = any> implements OnChanges, AfterViewInit {
  ...
  public ngOnChanges(changes: SimpleChanges): void {
    if ((changes.data || changes.cell) && this.cell) {
      ...
      this.icon = typeof this.cell?.icon === 'function' ? this.cell.icon(this.data, this.cell) : null;
      this.svgIcon = typeof this.cell?.svgIcon === 'function' ? this.cell.svgIcon(this.data, this.cell) : null;
    }
  }
